...
DROP TABLE IF EXISTS `#__podcast_episodes`;

CREATE TABLE `#__podcast_episodes` (
...
INSERT INTO `#__podcast_episodes` (`episode_id`, `feed_id`, `item_title`, `alias`, `item_author`, `item_subtitle`, `item_summary`, `item_enclosure_url`, `item_enclosure_length`, `item_enclosure_type`, `item_guid`, `item_pubDate`, `item_duration`, `item_keywords`, `item_isClosedCaptioned`, `item_created`, `item_image`, `item_block`, `published`)
VALUES
